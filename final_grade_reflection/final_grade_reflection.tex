...
program efficiency effect. Instead of creating a mutate with changing
the variable to a factor for all the variables I needed to do, I instead
followed to crease conciser code by including an across function (and
did in the labs that followed). I feel like I also accomplished a heavy
accomplishment with data by the use of different joins, as well as
filtering joins.
